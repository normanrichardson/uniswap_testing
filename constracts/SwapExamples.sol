...
contract SwapExample{
    ...
    function swapExactInputSingle (uint256 ammount) {
    ...
    function swapExactOutputSingle (uint256 amountOut, uint256 ammountMax) return (bool) {
        address memory recipient = msg.sender
        ...
        actAmountOut = router.exactOutputSingle(params);
